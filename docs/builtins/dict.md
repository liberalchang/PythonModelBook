...
- [zip() - 打包函数](zip.md) - 并行迭代

### 相关模块
- [collections模块](../stdlib/collections.md) - 容器数据类型
- [copy模块](../stdlib/copy.md) - 拷贝操作
- [json模块](../stdlib/json.md) - JSON处理
- [pickle模块](../stdlib/pickle.md) - 对象序列化

### 相关概念
- [字典推导式](../basics/dict-comprehensions.md) - 字典生成
- [映射类型](../basics/mapping-types.md) - 映射操作
