...
description: Python datetime 模块的完整指南，包含日期时间创建、格式化、计算和时区处理
author: Python 文档团队
date: 2024-01-01
updated: 2024-01-01
version: 1.0
...
print(f"2024 年 2 月: {first} 到 {last}")
...
- [ISO 8601 日期时间标准](https://en.wikipedia.org/wiki/ISO_8601)
- [时区数据库](https://www.iana.org/time-zones)
- [Python 时区处理最佳实践](https://docs.python.org/3/library/datetime.html#timezone-objects)
